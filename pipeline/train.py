...
if __name__=='__main__':
    ...
    platos6 = model_.groupby_column(column="platform_os",index=6)
    platos5 = model_.groupby_column(column="platform_os",index=5)
    browser_1 = model_.groupby_column(column="browser",index=1)
    browser_2 = model_.groupby_column(column="browser",index=2)
    if not os.path.exists("outputs"):
        os.makedirs("outputs")

    platos6.to_csv("outputs/platos6.csv")
    platos6.to_csv("../data/platos6.csv")
    platos5.to_csv("outputs/platos5.csv")
    platos5.to_csv("../data/platos5.csv")
    ...
    log_artifact("outputs/platos6.csv")
    log_artifact("outputs/platos5.csv")
